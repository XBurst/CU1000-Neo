...
enum opt_code
{
  ...
  OPT_Wmultiple_inheritance = 303,           /* -Wmultiple-inheritance */
  OPT_Wnamespaces = 304,                     /* -Wnamespaces */
  OPT_Wnarrowing = 305,                      /* -Wnarrowing */
  OPT_Wnested_externs = 306,                 /* -Wnested-externs */
  OPT_Wnls = 307,                            /* -Wnls */
  OPT_Wno_effect_assign = 308,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 309,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 310,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 311,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 312,                        /* -Wnonnull */
  /* OPT_Wnormalized = 313, */               /* -Wnormalized */
  OPT_Wnormalized_ = 314,                    /* -Wnormalized= */
  OPT_Wnull = 315,                           /* -Wnull */
  OPT_Wodr = 316,                            /* -Wodr */
  OPT_Wold_style_cast = 317,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 318,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 319,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 320,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 321,                    /* -Wout-of-date */
  OPT_Wover_ann = 322,                       /* -Wover-ann */
  ...
  OPT_Wp_ = 327,                             /* -Wp, */
  OPT_Wpacked = 328,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 329,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 330,                         /* -Wpadded */
  OPT_Wparam_assign = 331,                   /* -Wparam-assign */
  OPT_Wparentheses = 332,                    /* -Wparentheses */
  OPT_Wpedantic = 333,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 334,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 335,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 336,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 337,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 338,            /* -Wpointer-to-int-cast */
  OPT_Wpoison_system_directories = 339,      /* -Wpoison-system-directories */
  OPT_Wpragmas = 340,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 341,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 342,                       /* -Wprotocol */
  OPT_Wpsabi = 343,                          /* -Wpsabi */
  OPT_Wraw = 344,                            /* -Wraw */
  OPT_Wreal_q_constant = 345,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 346,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 347,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 348,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 349,            /* -Wredundant-modifiers */
  OPT_Wreorder = 350,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 351,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 352,                    /* -Wreturn-type */
  OPT_Wselector = 353,                       /* -Wselector */
  OPT_Wsequence_point = 354,                 /* -Wsequence-point */
  OPT_Wserial = 355,                         /* -Wserial */
  OPT_Wshadow = 356,                         /* -Wshadow */
  OPT_Wshadow_ivar = 357,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 358,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 359,           /* -Wshift-count-overflow */
  ...
  OPT_Wspecial_param_hiding = 366,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 367,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 368,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 369,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 370,                /* -Wstatic-receiver */
  ...
  OPT_Wsuppress = 385,                       /* -Wsuppress */
  OPT_Wsurprising = 386,                     /* -Wsurprising */
  OPT_Wswitch = 387,                         /* -Wswitch */
  OPT_Wswitch_bool = 388,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 389,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 390,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 391,                      /* -Wsync-nand */
  OPT_Wsynth = 392,                          /* -Wsynth */
  OPT_Wsynthetic_access = 393,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 394,                 /* -Wsystem-headers */
  OPT_Wtabs = 395,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 396,                /* -Wtarget-lifetime */
  OPT_Wtasks = 397,                          /* -Wtasks */
  OPT_Wtemplates = 398,                      /* -Wtemplates */
  ...
  OPT_Wtype_hiding = 403,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 404,                    /* -Wtype-limits */
  OPT_Wuncheck = 405,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 406,            /* -Wundeclared-selector */
  OPT_Wundef = 407,                          /* -Wundef */
  OPT_Wunderflow = 408,                      /* -Wunderflow */
  OPT_Wuninitialized = 409,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 410,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 411,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 412,              /* -Wunqualified-field */
  ...
  OPT_Wunused_argument = 417,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 418,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 419,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 420,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 421,                /* -Wunused-function */
  OPT_Wunused_import = 422,                  /* -Wunused-import */
  OPT_Wunused_label = 423,                   /* -Wunused-label */
  OPT_Wunused_local = 424,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 425,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 426,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 427,               /* -Wunused-parameter */
  OPT_Wunused_private = 428,                 /* -Wunused-private */
  OPT_Wunused_result = 429,                  /* -Wunused-result */
  OPT_Wunused_thrown = 430,                  /* -Wunused-thrown */
  OPT_Wunused_value = 431,                   /* -Wunused-value */
  OPT_Wunused_variable = 432,                /* -Wunused-variable */
  OPT_Wuse_without_only = 433,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 434,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 435,             /* -Wuseless-type-check */
  OPT_Wvarargs = 436,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 437,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 438,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 439,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 440,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 441,            /* -Wvirtual-move-assign */
  OPT_Wvla = 442,                            /* -Wvla */
  OPT_Wvolatile_register_var = 443,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 444,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 445,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 446,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 447,                       /* -Wzerotrip */
  OPT_Xassembler = 448,                      /* -Xassembler */
  OPT_Xlinker = 449,                         /* -Xlinker */
  OPT_Xpreprocessor = 450,                   /* -Xpreprocessor */
  OPT_Z = 451,                               /* -Z */
  OPT_ansi = 452,                            /* -ansi */
  OPT_aux_info = 453,                        /* -aux-info */
  /* OPT_aux_info_ = 454, */                 /* -aux-info= */
  OPT_auxbase = 455,                         /* -auxbase */
  OPT_auxbase_strip = 456,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 457, */             /* -bootclasspath */
  OPT_c = 458,                               /* -c */
  /* OPT_classpath = 459, */                 /* -classpath */
  OPT_coverage = 460,                        /* -coverage */
  OPT_cpp = 461,                             /* -cpp */
  OPT_cpp_ = 462,                            /* -cpp= */
  OPT_d = 463,                               /* -d */
  OPT_dumpbase = 464,                        /* -dumpbase */
  OPT_dumpdir = 465,                         /* -dumpdir */
  OPT_dumpmachine = 466,                     /* -dumpmachine */
  OPT_dumpspecs = 467,                       /* -dumpspecs */
  OPT_dumpversion = 468,                     /* -dumpversion */
  OPT_e = 469,                               /* -e */
  /* OPT_encoding = 470, */                  /* -encoding */
  OPT_export_dynamic = 471,                  /* -export-dynamic */
  OPT_extdirs = 472,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 473, */               /* -fCLASSPATH= */
  OPT_fPIC = 474,                            /* -fPIC */
  OPT_fPIE = 475,                            /* -fPIE */
  OPT_fRTS_ = 476,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 477,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 478,                   /* -fabi-version= */
  OPT_faccess_control = 479,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 480,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 481,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 482,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 483,                  /* -falign-commons */
  OPT_falign_functions = 484,                /* -falign-functions */
  OPT_falign_functions_ = 485,               /* -falign-functions= */
  OPT_falign_jumps = 486,                    /* -falign-jumps */
  OPT_falign_jumps_ = 487,                   /* -falign-jumps= */
  OPT_falign_labels = 488,                   /* -falign-labels */
  OPT_falign_labels_ = 489,                  /* -falign-labels= */
  OPT_falign_loops = 490,                    /* -falign-loops */
  OPT_falign_loops_ = 491,                   /* -falign-loops= */
  OPT_fall_intrinsics = 492,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 493, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 494,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 495,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 496, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 497, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 498, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 499, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 500, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 501,            /* -fasan-shadow-offset= */
  OPT_fasm = 502,                            /* -fasm */
  OPT_fassert = 503,                         /* -fassert */
  OPT_fassociative_math = 504,               /* -fassociative-math */
  OPT_fassume_compiled = 505,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 506,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 507,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 508,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 509,                   /* -fauto-profile */
  OPT_fauto_profile_ = 510,                  /* -fauto-profile= */
  OPT_fautomatic = 511,                      /* -fautomatic */
  OPT_faux_classpath = 512,                  /* -faux-classpath */
  OPT_fbackslash = 513,                      /* -fbackslash */
  OPT_fbacktrace = 514,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 515,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 516,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 517,              /* -fbootstrap-classes */
  OPT_fbounds_check = 518,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 519,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 520,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 521,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 522,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 523,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 524,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 525,                        /* -fbuiltin */
  OPT_fbuiltin_ = 526,                       /* -fbuiltin- */
  ...
  OPT_fcheck_array_temporaries = 531,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 532,                /* -fcheck-data-deps */
  OPT_fcheck_new = 533,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 534,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 535,               /* -fcheck-references */
  OPT_fcheck_ = 536,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 537,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 538,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 539,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 540,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 541,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 542,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 543,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 544, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 545,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 546,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 547,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 548, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 549,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 550,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 551,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 552,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 553,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 554,                       /* -fcilkplus */
  OPT_fclasspath_ = 555,                     /* -fclasspath= */
  OPT_fcoarray_ = 556,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 557,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 558,                         /* -fcommon */
  OPT_fcompare_debug = 559,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 560,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 561,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 562,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 563,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 564,                  /* -fcond-mismatch */
  OPT_fconserve_space = 565,                 /* -fconserve-space */
  OPT_fconserve_stack = 566,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 567,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 568,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 569,                       /* -fconvert= */
  OPT_fcprop_registers = 570,                /* -fcprop-registers */
  OPT_fcray_pointer = 571,                   /* -fcray-pointer */
  OPT_fcrossjumping = 572,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 573,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 574, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 575,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 576,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 577,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 578,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 579,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 580,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 581,                       /* -fdbg-cnt= */
  OPT_fdce = 582,                            /* -fdce */
  OPT_fdebug_cpp = 583,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 584,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 585,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 586,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 587,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 588,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 589, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 590,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 591,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 592,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 593,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 594,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 595,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 596,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 597,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 598,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 599, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 600,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 601,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 602,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 603,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 604,                /* -fdirectives-only */
  OPT_fdisable_ = 605,                       /* -fdisable- */
  OPT_fdisable_assertions = 606,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 607,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 608,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 609,         /* -fdollars-in-identifiers */
  OPT_fdse = 610,                            /* -fdse */
  OPT_fdump_ = 611,                          /* -fdump- */
  OPT_fdump_ada_spec = 612,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 613,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 614, */                /* -fdump-core */
  OPT_fdump_final_insns = 615,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 616,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 617,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 618,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 619,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 620,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 621, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 622,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 623,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 624,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 625,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 626,                 /* -fearly-inlining */
  OPT_felide_constructors = 627,             /* -felide-constructors */
  ...
  OPT_femit_class_file = 632,                /* -femit-class-file */
  OPT_femit_class_files = 633,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 634,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 635,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 636,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 637,                        /* -fenable- */
  OPT_fenable_assertions = 638,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 639,             /* -fenable-assertions= */
  OPT_fencoding_ = 640,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 641,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 642, */           /* -fenum-int-equiv */
  OPT_fexceptions = 643,                     /* -fexceptions */
  OPT_fexcess_precision_ = 644,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 645,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 646,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 647,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 648,                       /* -fextdirs= */
  OPT_fextended_identifiers = 649,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 650,                /* -fextern-tls-init */
  OPT_fexternal_blas = 651,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 652, */       /* -fexternal-templates */
  OPT_ff2c = 653,                            /* -ff2c */
  OPT_ffast_math = 654,                      /* -ffast-math */
  OPT_ffat_lto_objects = 655,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 656,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 657,               /* -ffinite-math-only */
  OPT_ffixed_ = 658,                         /* -ffixed- */
  OPT_ffixed_form = 659,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 660,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 661,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 662,                    /* -ffloat-store */
  OPT_ffor_scope = 663,                      /* -ffor-scope */
  /* OPT_fforce_addr = 664, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 665,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 666,              /* -fforward-propagate */
  OPT_ffp_contract_ = 667,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 668,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 669,                      /* -ffpe-trap= */
  OPT_ffree_form = 670,                      /* -ffree-form */
  OPT_ffree_line_length_ = 671,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 672,          /* -ffree-line-length-none */
  OPT_ffreestanding = 673,                   /* -ffreestanding */
  OPT_ffriend_injection = 674,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 675,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 676,                   /* -ffunction-cse */
  OPT_ffunction_sections = 677,              /* -ffunction-sections */
  OPT_fgcse = 678,                           /* -fgcse */
  OPT_fgcse_after_reload = 679,              /* -fgcse-after-reload */
  OPT_fgcse_las = 680,                       /* -fgcse-las */
  OPT_fgcse_lm = 681,                        /* -fgcse-lm */
  OPT_fgcse_sm = 682,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 683,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 684,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 685,                         /* -fgnu-tm */
  OPT_fgnu_unique = 686,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 687,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 688,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 689,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 690,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 691,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 692,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 693,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 694,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 695,                       /* -fgraphite */
  OPT_fgraphite_identity = 696,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 697,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 698, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 699, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 700,           /* -fhash-synchronization */
  /* OPT_fhelp = 701, */                     /* -fhelp */
  /* OPT_fhelp_ = 702, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 703,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 704, */                /* -fhonor-std */
  OPT_fhosted = 705,                         /* -fhosted */
  /* OPT_fhuge_objects = 706, */             /* -fhuge-objects */
  OPT_fident = 707,                          /* -fident */
  OPT_fif_conversion = 708,                  /* -fif-conversion */
  OPT_fif_conversion2 = 709,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 710,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 711,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 712,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 713,             /* -fimplicit-templates */
  OPT_findirect_classes = 714,               /* -findirect-classes */
  OPT_findirect_dispatch = 715,              /* -findirect-dispatch */
  OPT_findirect_inlining = 716,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 717,         /* -finhibit-size-directive */
  OPT_finit_character_ = 718,                /* -finit-character= */
  OPT_finit_integer_ = 719,                  /* -finit-integer= */
  OPT_finit_local_zero = 720,                /* -finit-local-zero */
  OPT_finit_logical_ = 721,                  /* -finit-logical= */
  OPT_finit_real_ = 722,                     /* -finit-real= */
  OPT_finline = 723,                         /* -finline */
  OPT_finline_atomics = 724,                 /* -finline-atomics */
  OPT_finline_functions = 725,               /* -finline-functions */
  OPT_finline_functions_called_once = 726,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 727, */            /* -finline-limit- */
  OPT_finline_limit_ = 728,                  /* -finline-limit= */
  OPT_finline_small_functions = 729,         /* -finline-small-functions */
  OPT_finput_charset_ = 730,                 /* -finput-charset= */
  OPT_finstrument_functions = 731,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 732,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 733,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 734,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 735,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 736,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 737,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 738,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 739,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 740,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 741,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 742,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 743, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 744,                    /* -fipa-profile */
  OPT_fipa_pta = 745,                        /* -fipa-pta */
  OPT_fipa_pure_const = 746,                 /* -fipa-pure-const */
  OPT_fipa_ra = 747,                         /* -fipa-ra */
  OPT_fipa_reference = 748,                  /* -fipa-reference */
  OPT_fipa_sra = 749,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 750, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 751,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 752,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 753,              /* -fira-loop-pressure */
  OPT_fira_region_ = 754,                    /* -fira-region= */
  OPT_fira_share_save_slots = 755,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 756,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 757,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 758,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 759,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 760,               /* -fivar-visibility= */
  OPT_fivopts = 761,                         /* -fivopts */
  OPT_fjni = 762,                            /* -fjni */
  OPT_fjump_tables = 763,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 764,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 765,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 766,             /* -fkeep-static-consts */
  ...
  OPT_flive_range_shrinkage = 771,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 772,                    /* -flocal-ivars */
  OPT_floop_block = 773,                     /* -floop-block */
  /* OPT_floop_flatten = 774, */             /* -floop-flatten */
  OPT_floop_interchange = 775,               /* -floop-interchange */
  OPT_floop_nest_optimize = 776,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 777, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 778,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 779,                /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 780,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 781,                      /* -flra-remat */
  OPT_flto = 782,                            /* -flto */
  OPT_flto_compression_level_ = 783,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 784,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 785,                 /* -flto-partition= */
  OPT_flto_report = 786,                     /* -flto-report */
  OPT_flto_report_wpa = 787,                 /* -flto-report-wpa */
  OPT_flto_ = 788,                           /* -flto= */
  OPT_fltrans = 789,                         /* -fltrans */
  OPT_fltrans_output_list_ = 790,            /* -fltrans-output-list= */
  OPT_fmain_ = 791,                          /* -fmain= */
  OPT_fmath_errno = 792,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 793,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 794,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 795,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 796,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 797,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 798,                     /* -fmem-report */
  OPT_fmem_report_wpa = 799,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 800,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 801,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 802,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 803,                /* -fmessage-length= */
  OPT_fmodule_private = 804,                 /* -fmodule-private */
  OPT_fmodulo_sched = 805,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 806,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 807,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 808,                  /* -fms-extensions */
  /* OPT_fmudflap = 809, */                  /* -fmudflap */
  /* OPT_fmudflapir = 810, */                /* -fmudflapir */
  /* OPT_fmudflapth = 811, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 812, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 813, */                  /* -fnew-abi */
  OPT_fnext_runtime = 814,                   /* -fnext-runtime */
  OPT_fnil_receivers = 815,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 816, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 817,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 818,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 819, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 820,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 821,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 822,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 823,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 824,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 825,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 826,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 827,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 828,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 829,                   /* -foffload-abi= */
  OPT_foffload_ = 830,                       /* -foffload= */
  OPT_fomit_frame_pointer = 831,             /* -fomit-frame-pointer */
  OPT_fopenacc = 832,                        /* -fopenacc */
  OPT_fopenmp = 833,                         /* -fopenmp */
  OPT_fopenmp_simd = 834,                    /* -fopenmp-simd */
  OPT_foperator_names = 835,                 /* -foperator-names */
  OPT_fopt_info = 836,                       /* -fopt-info */
  OPT_fopt_info_ = 837,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 838, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 839,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 840,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 841,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 842, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 843,              /* -foutput-class-dir= */
  OPT_fpack_derived = 844,                   /* -fpack-derived */
  OPT_fpack_struct = 845,                    /* -fpack-struct */
  OPT_fpack_struct_ = 846,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 847,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 848,              /* -fpcc-struct-return */
  OPT_fpch_deps = 849,                       /* -fpch-deps */
  OPT_fpch_preprocess = 850,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 851,                     /* -fpeel-loops */
  OPT_fpeephole = 852,                       /* -fpeephole */
  OPT_fpeephole2 = 853,                      /* -fpeephole2 */
  OPT_fpermissive = 854,                     /* -fpermissive */
  OPT_fpic = 855,                            /* -fpic */
  OPT_fpie = 856,                            /* -fpie */
  OPT_fplan9_extensions = 857,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 858,                    /* -fplugin-arg- */
  OPT_fplugin_ = 859,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 860,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 861,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 862,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 863,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 864,                   /* -fpreprocessed */
  OPT_fpretty_templates = 865,               /* -fpretty-templates */
  OPT_fprofile = 866,                        /* -fprofile */
  OPT_fprofile_arcs = 867,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 868,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 869,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 870,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 871,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 872,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 873,                 /* -fprofile-report */
  ...
  OPT_freduced_reflection = 893,             /* -freduced-reflection */
  OPT_free = 894,                            /* -free */
  OPT_freg_struct_return = 895,              /* -freg-struct-return */
  /* OPT_fregmove = 896, */                  /* -fregmove */
  OPT_frename_registers = 897,               /* -frename-registers */
  OPT_freorder_blocks = 898,                 /* -freorder-blocks */
  ...
  OPT_fsaw_java_file = 916,                  /* -fsaw-java-file */
  ...
  OPT_fshort_double = 947,                   /* -fshort-double */
  ...
  OPT_fsource_filename_ = 960,               /* -fsource-filename= */
  OPT_fsource_ = 961,                        /* -fsource= */
  ...
  OPT_fssa_phiopt = 966,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 967,                   /* -fstack-arrays */
  /* OPT_fstack_check = 968, */              /* -fstack-check */
  OPT_fstack_check_ = 969,                   /* -fstack-check= */
  OPT_fstack_limit = 970,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 971,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 972,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 973,                /* -fstack-protector */
  OPT_fstack_protector_all = 974,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 975,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 976,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 977,                   /* -fstack-reuse= */
  OPT_fstack_usage = 978,                    /* -fstack-usage */
  OPT_fstats = 979,                          /* -fstats */
  OPT_fstdarg_opt = 980,                     /* -fstdarg-opt */
  OPT_fstore_check = 981,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 982, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 983,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 984,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 985,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 986, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 987,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 988,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 989,                    /* -fsyntax-only */
  OPT_ftabstop_ = 990,                       /* -ftabstop= */
  /* OPT_ftarget_help = 991, */              /* -ftarget-help */
  OPT_ftarget_ = 992,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 993,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 994, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 995,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 996,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 997, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 998,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 999,             /* -fthreadsafe-statics */
  OPT_ftime_report = 1000,                   /* -ftime-report */
  OPT_ftls_model_ = 1001,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1002,              /* -ftoplevel-reorder */
  OPT_ftracer = 1003,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1004,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1005,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1006,                 /* -ftrapping-math */
  OPT_ftrapv = 1007,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1008,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1009,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1010,                      /* -ftree-ccp */
  OPT_ftree_ch = 1011,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1012,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1013,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1014,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1015,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1016,                   /* -ftree-cselim */
  OPT_ftree_dce = 1017,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1018,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1019,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1020,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1021,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1022, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1023,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1024,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1025,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1026,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1027,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1028, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1029,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1030,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1031,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1032,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1033,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1034,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1035,                      /* -ftree-pre */
  OPT_ftree_pta = 1036,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1037,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1038, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1039,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1040,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1041,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1042,                     /* -ftree-slsr */
  OPT_ftree_sra = 1043,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1044, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1045, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1046,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1047,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1048,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1049, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1050,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1051, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1052,                      /* -ftree-vrp */
  OPT_funderscoring = 1053,                  /* -funderscoring */
  OPT_funit_at_a_time = 1054,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1055,              /* -funroll-all-loops */
  OPT_funroll_loops = 1056,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1057,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1058,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1059,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1060,                 /* -funsigned-char */
  OPT_funswitch_loops = 1061,                /* -funswitch-loops */
  OPT_funwind_tables = 1062,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1063,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1064,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1065,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1066,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1067,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1068,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1069,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1070,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1071,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1072,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1073,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1074,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1075,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1076, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1077,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1078,                   /* -fverbose-asm */
  /* OPT_fversion = 1079, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1080,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1081,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1082,                   /* -fvisibility= */
  OPT_fvpt = 1083,                           /* -fvpt */
  /* OPT_fvtable_gc = 1084, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1085, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1086,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1087,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1088,                     /* -fvtv-debug */
  OPT_fweak = 1089,                          /* -fweak */
  OPT_fweb = 1090,                           /* -fweb */
  /* OPT_fwhole_file = 1091, */              /* -fwhole-file */
  OPT_fwhole_program = 1092,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1093,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1094,             /* -fworking-directory */
  OPT_fwpa = 1095,                           /* -fwpa */
  OPT_fwpa_ = 1096,                          /* -fwpa= */
  OPT_fwrapv = 1097,                         /* -fwrapv */
  /* OPT_fxref = 1098, */                    /* -fxref */
  /* OPT_fzee = 1099, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1100,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1101,                     /* -fzero-link */
  OPT_g = 1102,                              /* -g */
  OPT_gant = 1103,                           /* -gant */
  OPT_gcoff = 1104,                          /* -gcoff */
  OPT_gdwarf = 1105,                         /* -gdwarf */
  OPT_gdwarf_ = 1106,                        /* -gdwarf- */
  OPT_gen_decls = 1107,                      /* -gen-decls */
  OPT_ggdb = 1108,                           /* -ggdb */
  OPT_ggnu_pubnames = 1109,                  /* -ggnu-pubnames */
  OPT_gnat = 1110,                           /* -gnat */
  OPT_gnatO = 1111,                          /* -gnatO */
  OPT_gno_pubnames = 1112,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1113,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1114,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1115,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1116,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1117,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1118,                   /* -gsplit-dwarf */
  OPT_gstabs = 1119,                         /* -gstabs */
  OPT_gstabs_ = 1120,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1121,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1122,                        /* -gtoggle */
  OPT_gvms = 1123,                           /* -gvms */
  OPT_gxcoff = 1124,                         /* -gxcoff */
  OPT_gxcoff_ = 1125,                        /* -gxcoff+ */
  OPT_gz = 1126,                             /* -gz */
  OPT_gz_ = 1127,                            /* -gz= */
  OPT_h = 1128,                              /* -h */
  OPT_idirafter = 1129,                      /* -idirafter */
  OPT_imacros = 1130,                        /* -imacros */
  OPT_imultiarch = 1131,                     /* -imultiarch */
  OPT_imultilib = 1132,                      /* -imultilib */
  OPT_include = 1133,                        /* -include */
  OPT_iplugindir_ = 1134,                    /* -iplugindir= */
  OPT_iprefix = 1135,                        /* -iprefix */
  OPT_iquote = 1136,                         /* -iquote */
  OPT_isysroot = 1137,                       /* -isysroot */
  OPT_isystem = 1138,                        /* -isystem */
  OPT_iwithprefix = 1139,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1140,              /* -iwithprefixbefore */
  OPT_k8 = 1141,                             /* -k8 */
  OPT_l = 1142,                              /* -l */
  OPT_lang_asm = 1143,                       /* -lang-asm */
  OPT_mabi_ = 1144,                          /* -mabi= */
  OPT_mabicalls = 1145,                      /* -mabicalls */
  OPT_mabs_ = 1146,                          /* -mabs= */
  OPT_mandroid = 1147,                       /* -mandroid */
  OPT_march_ = 1148,                         /* -march= */
  OPT_mbionic = 1149,                        /* -mbionic */
  OPT_mbranch_cost_ = 1150,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1151,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1152,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1153,                /* -mcode-readable= */
  OPT_mcompact_eh = 1154,                    /* -mcompact-eh */
  OPT_mdebug = 1155,                         /* -mdebug */
  OPT_mdebugd = 1156,                        /* -mdebugd */
  OPT_mdivide_breaks = 1157,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1158,                  /* -mdivide-traps */
  OPT_mdmx = 1159,                           /* -mdmx */
  OPT_mdouble_float = 1160,                  /* -mdouble-float */
  OPT_mdsp = 1161,                           /* -mdsp */
  OPT_mdspr2 = 1162,                         /* -mdspr2 */
  OPT_meb = 1163,                            /* -meb */
  OPT_mel = 1164,                            /* -mel */
  OPT_membedded_data = 1165,                 /* -membedded-data */
  OPT_meva = 1166,                           /* -meva */
  OPT_mexplicit_relocs = 1167,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1168,                  /* -mextern-sdata */
  OPT_mfix_24k = 1169,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1170,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1171,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1172,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1173,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1174,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1175,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1176,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1177,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1178,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1179,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1180,                 /* -mfp-exceptions */
  OPT_mfp32 = 1181,                          /* -mfp32 */
  OPT_mfp64 = 1182,                          /* -mfp64 */
  OPT_mfpxx = 1183,                          /* -mfpxx */
  OPT_mframe_header_opt = 1184,              /* -mframe-header-opt */
  OPT_mfused_madd = 1185,                    /* -mfused-madd */
  OPT_mfusion = 1186,                        /* -mfusion */
  OPT_mglibc = 1187,                         /* -mglibc */
  OPT_mgp32 = 1188,                          /* -mgp32 */
  OPT_mgp64 = 1189,                          /* -mgp64 */
  OPT_mgpopt = 1190,                         /* -mgpopt */
  OPT_mhard_float = 1191,                    /* -mhard-float */
  OPT_mimadd = 1192,                         /* -mimadd */
  OPT_minterlink_compressed = 1193,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1194,              /* -minterlink-mips16 */
  OPT_mips = 1195,                           /* -mips */
  OPT_mips16 = 1196,                         /* -mips16 */
  OPT_mips16e = 1197,                        /* -mips16e */
  OPT_mips3d = 1198,                         /* -mips3d */
  OPT_mllsc = 1199,                          /* -mllsc */
  OPT_mlocal_sdata = 1200,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1201,                    /* -mlong-calls */
  OPT_mlong32 = 1202,                        /* -mlong32 */
  OPT_mlong64 = 1203,                        /* -mlong64 */
  OPT_mlra = 1204,                           /* -mlra */
  OPT_mmad = 1205,                           /* -mmad */
  OPT_mmcount_ra_address = 1206,             /* -mmcount-ra-address */
  OPT_mmcu = 1207,                           /* -mmcu */
  OPT_mmemcpy = 1208,                        /* -mmemcpy */
  OPT_mmicromips = 1209,                     /* -mmicromips */
  OPT_mmsa = 1210,                           /* -mmsa */
  OPT_mmt = 1211,                            /* -mmt */
  OPT_mmxu = 1212,                           /* -mmxu */
  OPT_mmxu2 = 1213,                          /* -mmxu2 */
  OPT_mnan_ = 1214,                          /* -mnan= */
  OPT_mno_float = 1215,                      /* -mno-float */
  OPT_mno_flush_func = 1216,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1217,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1218,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1219,                     /* -mno-mips3d */
  OPT_modd_spreg = 1220,                     /* -modd-spreg */
  OPT_mpaired_single = 1221,                 /* -mpaired-single */
  OPT_mplt = 1222,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1223,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1224,               /* -mrelax-pic-calls */
  OPT_mshared = 1225,                        /* -mshared */
  OPT_msingle_float = 1226,                  /* -msingle-float */
  OPT_mslsa = 1227,                          /* -mslsa */
  OPT_msmartmips = 1228,                     /* -msmartmips */
  OPT_msoft_float = 1229,                    /* -msoft-float */
  OPT_msplit_addresses = 1230,               /* -msplit-addresses */
  OPT_msym32 = 1231,                         /* -msym32 */
  OPT_msynci = 1232,                         /* -msynci */
  OPT_mtune_ = 1233,                         /* -mtune= */
  OPT_muclibc = 1234,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1235,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1236,                          /* -mvirt */
  OPT_mvr4130_align = 1237,                  /* -mvr4130-align */
  OPT_mxgot = 1238,                          /* -mxgot */
  OPT_mxpa = 1239,                           /* -mxpa */
  OPT_n = 1240,                              /* -n */
  OPT_no_canonical_prefixes = 1241,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1242,              /* -no-integrated-cpp */
  OPT_noasmopt = 1243,                       /* -noasmopt */
  OPT_nocpp = 1244,                          /* -nocpp */
  OPT_nodefaultlibs = 1245,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1246,                   /* -nostartfiles */
  OPT_nostdinc = 1247,                       /* -nostdinc */
  OPT_nostdinc__ = 1248,                     /* -nostdinc++ */
  OPT_nostdlib = 1249,                       /* -nostdlib */
  OPT_o = 1250,                              /* -o */
  OPT_p = 1251,                              /* -p */
  OPT_pass_exit_codes = 1252,                /* -pass-exit-codes */
  /* OPT_pedantic = 1253, */                 /* -pedantic */
  OPT_pedantic_errors = 1254,                /* -pedantic-errors */
  OPT_pg = 1255,                             /* -pg */
  OPT_pie = 1256,                            /* -pie */
  OPT_pipe = 1257,                           /* -pipe */
  OPT_posix = 1258,                          /* -posix */
  OPT_print_file_name_ = 1259,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1260,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1261,          /* -print-multi-directory */
  OPT_print_multi_lib = 1262,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1263,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1264,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1265,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1266,               /* -print-prog-name= */
  OPT_print_search_dirs = 1267,              /* -print-search-dirs */
  OPT_print_sysroot = 1268,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1269,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1270,                        /* -profile */
  OPT_pthread = 1271,                        /* -pthread */
  OPT_quiet = 1272,                          /* -quiet */
  OPT_r = 1273,                              /* -r */
  OPT_rdynamic = 1274,                       /* -rdynamic */
  OPT_remap = 1275,                          /* -remap */
  OPT_s = 1276,                              /* -s */
  OPT_s_bc_abi = 1277,                       /* -s-bc-abi */
  OPT_save_temps = 1278,                     /* -save-temps */
  OPT_save_temps_ = 1279,                    /* -save-temps= */
  OPT_shared = 1280,                         /* -shared */
  OPT_shared_libgcc = 1281,                  /* -shared-libgcc */
  /* OPT_specs = 1282, */                    /* -specs */
  OPT_specs_ = 1283,                         /* -specs= */
  OPT_static = 1284,                         /* -static */
  OPT_static_libasan = 1285,                 /* -static-libasan */
  OPT_static_libgcc = 1286,                  /* -static-libgcc */
  OPT_static_libgcj = 1287,                  /* -static-libgcj */
  OPT_static_libgfortran = 1288,             /* -static-libgfortran */
  OPT_static_libgo = 1289,                   /* -static-libgo */
  OPT_static_liblsan = 1290,                 /* -static-liblsan */
  OPT_static_libmpx = 1291,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1292,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1293,               /* -static-libstdc++ */
  OPT_static_libtsan = 1294,                 /* -static-libtsan */
  OPT_static_libubsan = 1295,                /* -static-libubsan */
  /* OPT_std_c__03 = 1296, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1297, */                /* -std=c++0x */
  OPT_std_c__11 = 1298,                      /* -std=c++11 */
  OPT_std_c__14 = 1299,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1300, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1301, */                /* -std=c++1y */
  OPT_std_c__1z = 1302,                      /* -std=c++1z */
  OPT_std_c__98 = 1303,                      /* -std=c++98 */
  OPT_std_c11 = 1304,                        /* -std=c11 */
  /* OPT_std_c1x = 1305, */                  /* -std=c1x */
  /* OPT_std_c89 = 1306, */                  /* -std=c89 */
  OPT_std_c90 = 1307,                        /* -std=c90 */
  OPT_std_c99 = 1308,                        /* -std=c99 */
  /* OPT_std_c9x = 1309, */                  /* -std=c9x */
  OPT_std_f2003 = 1310,                      /* -std=f2003 */
  OPT_std_f2008 = 1311,                      /* -std=f2008 */
  OPT_std_f2008ts = 1312,                    /* -std=f2008ts */
  OPT_std_f95 = 1313,                        /* -std=f95 */
  OPT_std_gnu = 1314,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1315, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1316, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1317,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1318,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1319, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1320, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1321,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1322,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1323,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1324, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1325, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1326,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1327,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1328, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1329, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1330,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1331, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1332, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1333, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1334,                     /* -std=legacy */
  OPT_symbolic = 1335,                       /* -symbolic */
  OPT_t = 1336,                              /* -t */
  OPT_time = 1337,                           /* -time */
  OPT_time_ = 1338,                          /* -time= */
  OPT_tno_android_cc = 1339,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1340,                 /* -tno-android-ld */
  OPT_traditional = 1341,                    /* -traditional */
  OPT_traditional_cpp = 1342,                /* -traditional-cpp */
  OPT_trigraphs = 1343,                      /* -trigraphs */
  OPT_u = 1344,                              /* -u */
  OPT_undef = 1345,                          /* -undef */
  OPT_v = 1346,                              /* -v */
  OPT_version = 1347,                        /* -version */
  OPT_w = 1348,                              /* -w */
  OPT_wrapper = 1349,                        /* -wrapper */
  OPT_x = 1350,                              /* -x */
  OPT_z = 1351,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
