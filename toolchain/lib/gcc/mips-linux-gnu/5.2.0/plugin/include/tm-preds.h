/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/toolchains/release/src/gcc-5-2015.11/gcc/config/mips/mips.md'.  */
...
extern int const_yi_operand (rtx, machine_mode);
...
extern int reg_or_0yi_operand (rtx, machine_mode);
...
extern int const_vector_same_uimm3_operand (rtx, machine_mode);
extern int const_vector_same_v16qi_set_operand (rtx, machine_mode);
extern int const_vector_same_v16qi_clr_operand (rtx, machine_mode);
extern int const_vector_same_cmpsimm4_operand (rtx, machine_mode);
extern int const_vector_same_cmpuimm4_operand (rtx, machine_mode);
extern int const_vector_same_simm10_operand (rtx, machine_mode);
extern int const_vector_same_uimm4_operand (rtx, machine_mode);
extern int const_vector_same_v8hi_set_operand (rtx, machine_mode);
extern int const_vector_same_v8hi_clr_operand (rtx, machine_mode);
extern int const_vector_same_v4si_set_operand (rtx, machine_mode);
extern int const_vector_same_v4si_clr_operand (rtx, machine_mode);
extern int const_vector_same_uimm6_operand (rtx, machine_mode);
extern int const_vector_same_v2di_set_operand (rtx, machine_mode);
extern int const_vector_same_v2di_clr_operand (rtx, machine_mode);
...
extern int const_vector_same_byte_operand (rtx, machine_mode);
...
extern int reg_or_vector_same_uimm3_operand (rtx, machine_mode);
extern int reg_or_vector_same_v16qi_set_operand (rtx, machine_mode);
extern int reg_or_vector_same_v16qi_clr_operand (rtx, machine_mode);
extern int reg_or_vector_same_uimm4_operand (rtx, machine_mode);
extern int reg_or_vector_same_v8hi_set_operand (rtx, machine_mode);
extern int reg_or_vector_same_v8hi_clr_operand (rtx, machine_mode);
extern int reg_or_vector_same_v4si_set_operand (rtx, machine_mode);
extern int reg_or_vector_same_v4si_clr_operand (rtx, machine_mode);
extern int reg_or_vector_same_uimm6_operand (rtx, machine_mode);
extern int reg_or_vector_same_v2di_set_operand (rtx, machine_mode);
extern int reg_or_vector_same_v2di_clr_operand (rtx, machine_mode);
extern int reg_or_vector_same_uimm8_operand (rtx, machine_mode);
extern int reg_or_vector_same_byte_operand (rtx, machine_mode);
extern int reg_or_vector_same_bitumm3_operand (rtx, machine_mode);
extern int reg_or_vector_same_bituimm4_operand (rtx, machine_mode);
extern int reg_or_vector_same_bituimm5_operand (rtx, machine_mode);
extern int reg_or_vector_same_bituimm6_operand (rtx, machine_mode);
